  ...
  return (
    <div className='flex justify-center items-center mt-32 lg:mt-[12%]'>
      <div className='font-inter text-white'>
        ...
        <div className='flex justify-center gap-12 mt-12 lg:gap-20'>
          <button className={`bg-primary border-accent border-2 h-20 w-36 rounded-2xl text-2xl transition duration-1000 lg:h-18 lg:w-4 ${displayVideo ? "opacity-25" : ""}`} style={{boxShadow: '9px 7px 3px #1C1D1D'}} onClick={reset}>RESET</button>
